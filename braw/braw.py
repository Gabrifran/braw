...
class Braw():
	...
	def braw(self,main):
			...
			self.p.setStyleSheet(f'border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/pao.png)')
			...
			self.pa.setStyleSheet(f"border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/loop.png);")
			...
			self.pe.setStyleSheet(f"border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/pedro.png);")
			self.pea=QtWidgets.QPushButton(main)
			self.pea.setGeometry(QtCore.QRect(370,176,63,63))
			self.pea.setStyleSheet(f"border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/loop.png);")
			...
			self.ya.setStyleSheet(f"border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/loop.png);")
			self.ya.clicked.connect(lambda:self.site(0,'Pablo YamoshiYamato'))
			self.y.setStyleSheet(f'border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/pablo.png);')
			...
			self.la.setStyleSheet(f"border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/loop.png);")
			self.la.clicked.connect(lambda:self.site(3,'Luffy'))
			self.l.setStyleSheet(f'border-image:url({(path.dirname(path.abspath(__file__))).replace('\\','/')}/img/luffy.png);')
